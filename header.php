...
<html>
	...
	<meta name="author" content="Crime Management system" />
	...
	<nav class="fh5co-nav" role="navigation">
		<div class="top-menu">
			<div class="container">
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo"><a href="index.php">C.M.S</a></div>
					</div>
					<div class="col-xs-10 text-right menu-1">
						<ul>
							...
							<li class="btn-cta"><a href="Admin/sign-up.php"><span>Sign Up</span></a></li>
